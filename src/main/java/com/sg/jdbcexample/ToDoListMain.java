...
public class ToDoListMain {
    ...
    // Connecting to the database todoDB
    private static DataSource gerDataSource() throws SQLException {
    ...
    private static void displayList() throws SQLException {
        try (Connection conn = ds.getConnection()) {
            ...
            // Notice that sql statement are case sensitive in this case. Need Uppercase statements
    ...
    private static void addItem() throws SQLException {
        ...
        try (Connection conn = ds.getConnection()){
            ...
            // Sends query to the database for updates
            pStmt.executeUpdate();
